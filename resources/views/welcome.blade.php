                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> +84 943 751 757</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> hphuc18298@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{URL::to('/danh-muc-san-pham/'.$cate->maLoai)}}">{{ $cate->tenLoai }}</a></h4>
                                </div>
                            </div>
                           @endforeach
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                ...
                                @foreach($brand as $key =>$brand)
                                    <li><a href="{{URL::to('/thuong-hieu-san-pham/'.$brand->maNcc)}}"> <span class="pull-right">(50)</span>{{ $brand->tenNcc }}</a></li>
                                @endforeach
                                </ul>
                            </div>
                        </div><!--/brands_products-->
